...
function Topnavbar() {
  ...
  /*hook to manage the dark and the light mode*/
  ...
  return (
    <>
      <div
        className={` r max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white fixed top-0 left-0 right-0 z-50 ${
          sticky
            ? "sticky-navbar shadow-md stick duration-300 dark:bg-slate-800 dark:text-white fixedtransition-all ease-in-out "
            : ""
        }`}
      >
          ...
          <div className="navbar-end space-x-3">
            ...
            <div className="hidden md:block">
              <label className="px-3 py-2 rounded-md border border border-indigo-200 flex items-center gap-2">
                <input
                  type="text"
                  className={`grow outline-none dark:bg-slate-900 dark:text-white search ${
                    sticky
